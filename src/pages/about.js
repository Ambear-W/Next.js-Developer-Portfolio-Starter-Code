                ...
                <Layout className='pt-16'>
                    ...
                    <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
                        ...
                        <div className='col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark bg-light p-8 
                                  dark:bg-dark dark:border-light xl:col-span-4 md:col-span-8'>
                            <div className='absolute top-0 -right-3 -z-10 w-[102%] h-[103%] rounded-[2rem] bg-dark 
                                        dark:bg-light md:order-1'/>
                        ...
                        <div className='col-span-2 flex flex-col items-end justify-between xl:col-span-8 xl:flex-row xl:items-center md:order-3'>
                            <Statistics number='50' title='satisfied clients' />
                            <Statistics number='40' title='projects completed' />
                            <Statistics number='4' title='years of experience' />
                        </div>
                    </div>
                    <Skills />
                    <Experience />
