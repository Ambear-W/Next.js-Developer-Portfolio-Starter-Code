...
const NavBar = () => {
  ...
  return (
    ...
    >
      ...
      <div className='w-full flex justify-between items-cent lg:hidden'>
        <nav>
...

      {
        isOpen ?
          <motion.div initial={{scale:0, opacity:0, x:"-50%", y:"-50%"}}
                      ...
                      className='min-w-[70vw] hidden flex-col justify-between items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-30
                               bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32 lg:flex'>
